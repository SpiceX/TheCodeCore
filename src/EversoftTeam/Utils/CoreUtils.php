...
class CoreUtils
{
    ...
    const AUTHENTICATE_MESSAGE = self::PREFIX . ": " . TE::GRAY . "Bienvenido a §fTheCod§4ê§f§r§7 un servidor code-featured donde podrás explorar multiples modalidades y divertirte en los minijuegos";
